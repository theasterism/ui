  ...
  return (
    <legend
      ...
      className={cn(
        "font-medium",
        "mb-1",
        "data-[variant=legend]:text-regular",
        "data-[variant=label]:text-small",
        className
      )}
      {...props}
    />
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Field component uses role="group" for proper form semantics
    <div
      role="group"
      data-slot="field"
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 font-medium text-small leading-snug group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-foreground-subtle text-small leading-normal",
