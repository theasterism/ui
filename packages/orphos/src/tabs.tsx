...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex gap-1 h-9 items-center rounded-lg p-[3px] text-foreground",
        className
      )}
      {...props}
    />
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "focus-visible:outline-none focus-visible:ring-2 ring-focus-ring ring-offset-background-subtle focus-visible:ring-offset-0 rounded-lg",
        className
      )}
      {...props}
    />
