...
const buttonVariants = cva({
  ...
  variants: {
    variant: {
      default:
        "shadow-[inset_0px_0.5px_0px_var(--gray-7),_inset_0px_0px_0px_0.5px_var(--gray-7)] dark:border-0 bg-background-element hover:bg-background-element-hover text-black dark:text-white active:bg-background-element-active",
