...
const buttonVariants = cva({
  ...
  variants: {
    variant: {
      default:
        "border border-border-element/60 bg-background dark:bg-background-subtle hover:bg-background-element-hover text-foreground active:bg-background-element-active",
