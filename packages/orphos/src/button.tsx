  ...
  "inline-flex items-center justify-center gap-x-2 whitespace-nowrap text-sm font-semibold transition-colors focus-visible:ring-2 focus-visible:ring-offset-background-subtle dark:focus-visible:ring-offset-background focus-visible:ring-offset-2 focus-visible:ring-info-focus-ring focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-foreground hover:bg-foreground/90 active:bg-foreground/90 text-background",
        soft: "bg-background-element hover:bg-background-element-hover active:bg-background-element-active text-foreground dark:text-white",
        ghost:
