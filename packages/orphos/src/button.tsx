...
const buttonVariants = cva({
  ...
  variants: {
    variant: {
      default:
        "border-[0.5px] border-element-border bg-background dark:bg-background-element hover:bg-background-element-hover text-black dark:text-white active:bg-background-element-active",
