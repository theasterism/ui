  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed inset-ring-1 inset-ring-border-element top-[50%] left-[50%] isolate z-50 grid w-full max-w-[calc(100vw-32px)] xs:max-w-md translate-x-[-50%] translate-y-[-50%] gap-6 overflow-hidden rounded-md bg-background-subtle p-6 duration-200 data-[state=closed]:animate-out data-[state=open]:animate-in",
          className
        )}
        {...props}>
        {children}
