...
export const typographyVariants = cva({
  variants: {
    variant: {
      ...
      paragraph:
        "text-base text-foreground-subtle leading-[1.6] [&:not(:first-child)]:mt-4",
      heading1:
        "scroll-m-20 text-balance font-semibold text-[32px] text-foreground leading-[1.4] sm:text-5xl [&:not(:first-child)]:mt-8",
      heading2:
      ...
      link: "font-medium text-info-surface-foreground underline decoration-border-element underline-offset-[2.5px] hover:decoration-info-surface-foreground",
      blockquote:
      ...
      code: "w-fit break-words rounded-sm border border-border-subtle bg-background-element px-[0.3rem] py-[0.075rem] text-foreground-subtle text-sm",
    },
  },
  defaultVariants: {
    variant: "paragraph",
