...
export const typographyVariants = cva({
  variants: {
    variant: {
      ...
      code: "w-fit break-words bg-background-element px-[0.3rem] py-[0.075rem] text-foreground-subtle text-sm [box-decoration-break:clone] before:content-(--code-marker) after:content-(--code-marker)",
      kbd: "order inline w-fit bg-background-element-hover px-1.5 py-px text-foreground text-xs [box-decoration-break:clone] dark:bg-background-element-active dark:text-foreground-subtle/85",
    },
  },
  defaultVariants: {
    variant: "paragraph",
