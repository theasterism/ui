...
export const typographyVariants = cva({
  variants: {
    variant: {
      ...
      heading1: "text-4xl  font-bold text-balance leading-[1.2] tracking-tight mt-8",
      heading2: "text-3xl font-bold text-balance leading-[1.3] tracking-tight mt-8",
      heading3: "text-2xl font-semibold text-balance leading-[1.3] tracking-tight mt-8",
      heading4: "text-xl font-semibold text-balance leading-[1.4] tracking-tight mt-8",
      heading5: "text-lg font-semibold text-balance leading-[1.4] tracking-tight mt-8",
