      ...
      <div className="relative">
        ...
        >
          {isVisible ? (
            ...
            <EyeOpenIcon className="size-4 stroke-2" aria-hidden="true" />
          )}
        </button>
      </div>
    );
