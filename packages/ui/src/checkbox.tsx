...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer size-6 shrink-0 transition-all rounded-sm border border-primary shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-background focus-visible:ring-offset-2 focus-visible:ring-info-focus-ring disabled:cursor-not-allowed disabled:opacity-50  data-[state=checked]:bg-primary-solid disabled:data-[state=unchecked]:bg-background-element disabled:data-[state=checked]:bg-primary-background-element disabled:data-[state=checked]:border-primary-element-border",
      className,
    )}
    {...props}
  >
